...
// Validate ../../src/app/api/webhooks/twilio/message-status/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/webhooks/twilio/message-status">> = Specific
  const handler = {} as typeof import("../../src/app/api/webhooks/twilio/message-status/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
